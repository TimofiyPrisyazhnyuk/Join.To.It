...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="/ ">Join.To.It</a>
            ...
            @else
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <div class="dropdown-item" data-toggle="modal" data-target="#exampleModal"
                             style="cursor: pointer;">
                            Logout <i class="fa fa-user-times"></i>
                        </div>
                        <div class="dropdown-item">
                            <a style="text-decoration: none" href="{{ url('/home') }}">Account
...
<div class="content-wrapper">
    ...
    <!-- Bootstrap core JavaScript-->
        ...
        <script src="{{ url('vendor/chart_js/Chart.min.js') }}"></script>
